...
// GetOnStock mocks base method.
func (m *MockProductInterface) GetOnStock() bool {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetOnStock")
	ret0, _ := ret[0].(bool)
	return ret0
}

// GetOnStock indicates an expected call of GetOnStock.
func (mr *MockProductInterfaceMockRecorder) GetOnStock() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetOnStock", reflect.TypeOf((*MockProductInterface)(nil).GetOnStock))
}
...
func (mr *MockProductInterfaceMockRecorder) IsActive() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsActive", reflect.TypeOf((*MockProductInterface)(nil).IsActive))
}
